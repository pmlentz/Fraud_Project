...
### Takeaways
Predicting fraudulent transactions is an important task in the utilization of credit cards. Customers expect the banks protection in not allowing their cards to be used for fraudulent transactions, but also don't want the embarrassment of their card being declined for a falsely flagged fraudulent transaction. Customers rightfully have high expectations of their bank and as data scientists we can contribute directly to customer satisfaction in this way.
